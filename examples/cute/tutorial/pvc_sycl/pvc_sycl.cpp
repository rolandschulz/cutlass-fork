...
int main(int argc, char **argv) {
  // M, K, N
  cute_gemm<256, 256, 32, 64, 32>(2048, 2048, 2048);
  cute_gemm<256, 256, 32, 64, 32>(4096, 4096, 4096);
  cute_gemm<256, 256, 32, 64, 32>(8192, 8192, 8192);

  cute_gemm<32, 512, 32, 32, 32>(1, 5120, 5120);
  cute_gemm<32, 512, 32, 32, 32>(1, 13824, 5120);
  cute_gemm<32, 512, 32, 32, 32>(1, 5120, 13824);

  cute_gemm<32, 512, 32, 32, 32>(4, 8192, 2048);
  cute_gemm<32, 512, 32, 32, 32>(4, 4096, 250880);
  cute_gemm<32, 512, 32, 32, 32>(4, 16384, 4096);
  cute_gemm<32, 512, 32, 32, 32>(4, 4096, 12288);
  cute_gemm<32, 512, 32, 32, 32>(4, 14336, 5376);

  cute_gemm<32, 512, 32, 32, 32>(256, 4096, 4096);
  cute_gemm<32, 512, 32, 32, 32>(512, 379, 2043);
  cute_gemm<32, 512, 32, 32, 32>(1024, 28672, 8192);
  cute_gemm<32, 512, 32, 32, 32>(8192, 1024, 4096);
